...
**Frontend:** React.js, Vue.js, HTML, CSS, React Native  
**Backend:** ASP .NET Core (Entity Framework), Node.js, Flask
**Databases:** PostgreSQL, MySQL, MS SQL Server, MongoDB, MS Access  
**Cloud & Tools:** AWS, Azure, GCP, Git, Docker, Kubernetes, Jenkins, Terraform  
**Other:** Git, Figma, Notion, Trello, Google Workspace, Microsoft 365  
